...
These layers can be used to construct CapsNet on other data set,
not just on MNIST.
*NOTE*: some functions can be implemented in multiple ways, I keep all of them.
You can try them for yourself just by uncommenting them and commenting their
counterparts.
...
class CapsuleLayer(layers.Layer):
    ...
    :param dim_capsule: output vector dimension of the capsules in this layer
